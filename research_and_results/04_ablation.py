...
elif language=='pl': ax[0].set_xlabel("Numer zbioru danych")
...
elif language=='pl': ax[1].set_xlabel("Numer zbioru danych")
...
elif language=='pl': ax[1].legend(["Idealne wyniki grupowania", "Idealne wyniki wykrywania anomalii", "Idealne wyniki predykcji", "Brak idealnych wyników"])
fig.show()
