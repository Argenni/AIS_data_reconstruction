...
ax[0].bar(x-0.15,OK_vec[:,0,0], width=0.1)
ax[0].bar(x-0.05,OK_vec[:,0,1], width=0.1)
ax[0].bar(x+0.05,OK_vec[:,0,2], width=0.1)
ax[0].bar(x+0.15,OK_vec[:,0,3], width=0.1)
ax[0].set_title("VAR")
...
ax[1].bar(x-0.15,OK_vec[:,1,0], width=0.1)
ax[1].bar(x-0.05,OK_vec[:,1,1], width=0.1)
ax[1].bar(x+0.05,OK_vec[:,1,2], width=0.1)
ax[1].bar(x+0.15,OK_vec[:,1,3], width=0.1)
